...
void display() {
    ...
    // draws buildings3 the purple ones
...
void cloudTimer(int dummy) {
    ...
    // check if user is overlapping cloud rect
...
void buildingTimer(int dummy) {
    ...
    // check if user is overlaping any buildings
